...
//      sqlElement(context.evalNodes("/mapper/sql"));
            sqlElement(context.evalNodes("/mapper/command"));
//      buildStatementFromContext(context.evalNodes("select|insert|update|delete"));
            buildStatementFromContext(context.evalNodes("sync|async"));
        } catch (Exception e) {
    ...
    protected void validateExecutableFile(XNode context, Class<?> enclosingType) {
    }
