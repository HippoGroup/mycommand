...
//    nodeHandlerMap.put("set", new SetHandler());
    ...
    public CommandSource parseScriptNode() {
        MixedSqlNode rootSqlNode = parseDynamicTags(context);
        CommandSource commandSource;
        if (isDynamic) {
            commandSource = new DynamicCommandSource(configuration, rootSqlNode);
        } else {
            commandSource = new RawCommandSource(configuration, rootSqlNode, parameterType);
        }
