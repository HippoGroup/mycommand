...
public class MapperRegistry {
    ...
    public <T> T getMapper(Class<T> type, CommandSession commandSession) {
        ...
        if (mapperProxyFactory == null) {
            throw new BindingException("Type " + type + " is not known to the MapperRegistry. Please check mapper XML namespace.");
        }
        try {
            return mapperProxyFactory.newInstance(commandSession);
        } catch (Exception e) {
