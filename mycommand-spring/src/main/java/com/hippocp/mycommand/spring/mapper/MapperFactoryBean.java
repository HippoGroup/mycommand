...
public class MapperFactoryBean<T> implements FactoryBean<T> {
  ...
  public CommandSessionFactory getCommandSessionFactory() {
    return commandSessionFactory;
  }

  public void setCommandSessionFactory(CommandSessionFactory commandSessionFactory) {
  ...
  protected void checkDaoConfig() {
    notNull(this.commandSession, "Property 'commandSession' is required");

    notNull(this.mapperInterface, "Property 'mapperInterface' is required");

    Configuration configuration = getCommandSession().getConfiguration();
  ...
  @Override
  public T getObject() {
    return getCommandSession().getMapper(this.mapperInterface);
  }
